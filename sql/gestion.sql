...
START TRANSACTION;
SET time_zone = "+00:00";
CREATE DATABASE IF NOT EXISTS `R401_projet_gestion` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON R401_projet_gestion.* TO 'R401_projet_gestion'@'%';
FLUSH PRIVILEGES;
